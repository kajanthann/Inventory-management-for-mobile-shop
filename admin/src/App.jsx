...
// ── Layout with sidebar (used for all protected pages) ──
const AppLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-[#121212] text-white">
      ...
      {/* Main Content */}
      <div className="flex-1 bg-[#0f0f0f] p-6 overflow-auto relative">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div style={{
            ...
            background: "rgba(180,10,10,0.06)", filter: "blur(55px)"
          }} />
          <div style={{
            position: "absolute", bottom: "15%", left: "20%",
            width: 180, height: 180, borderRadius: "50%",
            background: "rgba(180,10,10,0.04)", filter: "blur(45px)"
          }} />
        </div>

        {/* Clock */}
        <div className="absolute top-0 right-0 m-4 z-10">
          <div className="px-4 py-2 flex items-center gap-2 bg-[#1a1a1a] border border-[#1f1f1f] rounded-lg text-sm text-gray-400">
            <FaClock className="text-[#b00000]" />
            {formatTime(time)}
          </div>
        </div>
