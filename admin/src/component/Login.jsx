...
const Bg = () => (
  <>
    ...
    <div className="absolute top-0 left-0 opacity-50 pointer-events-none" style={{ width: "280px", height: "280px", transform: "rotate(135deg)" }}><SpiderWeb /></div>
    <div className="absolute bottom-0 right-0 opacity-40 pointer-events-none" style={{ width: "240px", height: "240px", transform: "rotate(-45deg)" }}><SpiderWeb /></div>
    <div className="absolute w-[350px] h-[350px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(150,5,5,0.22) 0%, transparent 70%)", top: "-80px", left: "-80px" }} />
    <div className="absolute w-[260px] h-[260px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(130,5,5,0.15) 0%, transparent 70%)", bottom: "-50px", right: "-50px" }} />
  </>
);

const cardStyle = { boxShadow: "0 0 60px rgba(150,5,5,0.15), 0 30px 60px rgba(0,0,0,0.8)" };
const inputStyle = { background: "#0a0a0a", border: "1px solid #1f1f1f" };
const toastStyle = { background: "#1a1a1a", color: "#fff", border: "1px solid #2a2a2a", borderRadius: "10px", fontSize: "13px" };

const successToast = (msg) => toast.success(msg, { style: { ...toastStyle, borderLeft: "3px solid #22c55e" }, iconTheme: { primary: "#22c55e", secondary: "#1a1a1a" } });
...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true);
    const toastId = toast.loading("Signing in...", { style: toastStyle });
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#050505] relative overflow-hidden">
      ...
      <div className="relative w-[400px] bg-[#111111] border border-[#1f1f1f] rounded-xl overflow-hidden" style={cardStyle}>
        ...
        <div className="px-6 py-5 border-b border-[#1f1f1f] flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 px-3 py-1 rounded-full border border-[#1f1f1f]" style={{ background: "rgba(150,5,5,0.12)" }}>
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            {/* Email */}
            <div>
              <label className="text-[11px] text-gray-600 font-semibold tracking-wider">EMAIL ADDRESS</label>
              <div className="relative mt-1">
                <FaEnvelope className="absolute left-3 top-3 text-gray-600 text-sm" />
                <input
                  type="email" required placeholder="admin@smartspider.com"
            ...
            {/* Password */}
            <div>
              <label className="text-[11px] text-gray-600 font-semibold tracking-wider">PASSWORD</label>
              <div className="relative mt-1">
