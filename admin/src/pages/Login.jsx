...
const SpiderWeb = () => (
  ...
  >
    {[0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330].map((angle, i) => {
      ...
      return (
        <line
          ...
          x1="250"
          y1="250"
          x2={250 + 260 * Math.cos(rad)}
          y2={250 + 260 * Math.sin(rad)}
          stroke="rgba(180,10,10,0.55)"
          strokeWidth="0.9"
        />
      );
    })}
    ...
    <path
      d="M243 238 Q220 228 205 218"
      stroke="rgba(180,10,10,0.7)"
      strokeWidth="1.3"
      fill="none"
      strokeLinecap="round"
    />
    <path
      d="M242 243 Q218 238 200 232"
      stroke="rgba(180,10,10,0.7)"
      strokeWidth="1.3"
      fill="none"
      strokeLinecap="round"
...
const Bg = () => (
  <>
    ...
    <div
      ...
      style={{
        background:
          "radial-gradient(circle, rgba(150,5,5,0.22) 0%, transparent 70%)",
        top: "-80px",
        left: "-80px",
      }}
    />
    <div
      ...
      style={{
        background:
          "radial-gradient(circle, rgba(130,5,5,0.15) 0%, transparent 70%)",
        bottom: "-50px",
        right: "-50px",
      }}
    />
...
const Login = () => {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const { data } = await axiosInstance.post("/api/admin/verify-otp", {
        email,
        otp: entered,
      });
  ...
  const CardHeader = () => (
    <div className="px-6 py-5 border-b border-[#1f1f1f] flex justify-between items-center">
      ...
      <div
        className="flex items-center gap-2 px-3 py-1 rounded-full border border-[#1f1f1f]"
  ...
  if (step === "login") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#050505] relative overflow-hidden">
        <Bg />
        <div
          className="relative w-[400px] bg-[#111111] border border-[#1f1f1f] rounded-xl overflow-hidden"
          style={cardStyle}
        >
          ...
          <div className="p-6">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <button
                ...
                onMouseLeave={(e) => {
                  if (!loading) e.currentTarget.style.background = "#b00000";
                }}
              >
                {loading ? (
                  <>
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-5">
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!otpLoading) e.currentTarget.style.background = "#8b0000";
              }}
              onMouseLeave={(e) => {
                if (!otpLoading) e.currentTarget.style.background = "#b00000";
              }}
            >
              {otpLoading ? (
                <>
